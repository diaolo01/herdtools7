...
module Make (C : sig
  ...
  module AArch64Constant =
    SymbConstant.Make (CapabilityScalar) (AArch64PteVal) (AArch64BlockVal) (AArch64TableVal) (AArch64Instr)
  module NoCst =
    SymbConstant.Make (CapabilityScalar) (PteVal.No) (BlockVal.No) (TableVal.No) (AArch64Instr)
