...
module Make (C : sig
  ...
  module AArch64Cst =
    SymbConstant.Make (Uint128Scalar) (AArch64PteVal) (AArch64BlockVal) (AArch64TableVal) (AArch64Instr)
  module NoCst =
    SymbConstant.Make (Uint128Scalar) (PteVal.No) (BlockVal.No) (TableVal.No) (AArch64Instr)
