...
module Make (C : sig
  ...
  module AArch64Cst =
    SymbConstant.Make (NeonScalar) (AArch64PteVal) (AArch64BlockVal) (AArch64TableVal) (AArch64Instr)
  module NoCst =
    SymbConstant.Make (NeonScalar) (PteVal.No) (BlockVal.No) (TableVal.No) (AArch64Instr)
